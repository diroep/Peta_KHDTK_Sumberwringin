...
map.getView().fit([12689136.619978, -894018.987408, 12692515.492771, -892342.943925], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta KHDTK Sumberwringin</h2>';
        return titleElement;
    })(),
